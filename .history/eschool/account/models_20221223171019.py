...
def upload_image_path(instance, filename):
    ...
    return f"teacher/profile/avatar/{new_filename}/{final_filename}"
...
class TeacherProfile(models.Model):
    ...
    height = models.PositiveIntegerField("Image Height", blank=True, null=True)    width = models.PositiveIntegerField("Image Width", blank=True, null=True)
