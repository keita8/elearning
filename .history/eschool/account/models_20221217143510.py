...
class UserManager(BaseUserManager):
    def create_user(
        self, email, password, is_admin, is_staff, is_superuser, is_active, **extra_fields
    ):
        if not email:
    ...
    def create_superuser(self, email, password, is_active, is_staff, is_superuser, is_ **extra_fields):
        user = self.create_user(email, password, True, True, True, True)
        return user
