...
class UserManager(BaseUserManager):
    def create_user(
        self, email, password, is_admin, is_staff, is_active
    ):
        if not email:
    ...
    def create_user(self, email, password, is_admin, is_active, is_staff):
        return self._create_user(email, password, False, False, False)

    def create_superuser(self, email, password, is_active, is_staff, is_admin):
        user = self.create_user(email, password, is_active=True, is_staff=True, is_admin=True)
        return user
