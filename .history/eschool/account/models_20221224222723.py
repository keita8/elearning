...
class StudentProfile(models.Model):
    ...
    user = models.OneToOneField(
        Account, on_delete=models.CASCADE, verbose_name="Adresse email", related_name='studentprofile'
    )
...
class TeacherProfile(models.Model):
    ...
    sex = models.CharField(max_length=20, null=True, blank=True, choices=Gender.choices, verbose_name="Genre")
    user = models.OneToOneField(
        Account, on_delete=models.CASCADE, verbose_name="Adresse email", related_name='teacherprofile'
    )
...
post_delete.connect(delete_teacher, sender=StudentProfile)
