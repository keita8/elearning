...
class TeacherProfile(models.Model):
    ...
    lastname = models.CharField(max_length=100, verbose_name="Nom de famille", default="keita")
    firstname = models.CharField(max_length=100, verbose_name="Prénom", default="abdul kabir")
    birth_date = models.DateField(
        verbose_name="Date de naissance", default=timezone.now
    )
    phone_number = PhoneNumberField(blank=True, null=True, verbose_name="Téléphone")
