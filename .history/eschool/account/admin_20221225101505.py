...
class ReceiverResource(resources.ModelResource):
    ...
    class Meta:
        ...
        fields = ('sex', 'user', 'lastname', 'firstname', 'birth_date', 'phone_number', 'bio')
        export_order = ('user', 'lastname', 'firstname', 'phone_number', 'birth_date')
    
    def dehydrate_created(self, obj):
        return obj.created.strftime("%d/%m/%Y à %H:%M:%S")
