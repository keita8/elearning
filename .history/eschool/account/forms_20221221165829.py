...
class UserLoginForm(forms.ModelForm):
    ...
    email = forms.EmailField(label="Adresse email", widget=forms.EmailInput(attrs={'placeholder': "Votre adresse email", 'required':True } ))
...
class TeacherProfileForm(forms.ModelForm):
    firstname = forms.CharField(widget=forms.)
    class Meta:
        model = TeacherProfile
        fields = ('user', 'sex', 'course', 'lastname', 'firstname', 'birth_date', 'phone_number', 'bio', 'image')
        exclude = ('user', )