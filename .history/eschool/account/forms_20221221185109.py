...
class TeacherProfileForm(forms.ModelForm):
    ...
    image = forms.ImageField(required=False, error_messages={'invalid':('Image au format png & jpg')}, widget=forms.FileInput)
    ...
    sex = forms.ChoiceField(
        label="Genre", widget=forms.Select(attrs={"class": "regDropDown"}),
        choices=SEX
    )

    bio = forms.CharField(widget=TinyMCE(attrs={'cols': 80, 'rows':50,'class': 'form-control'})
