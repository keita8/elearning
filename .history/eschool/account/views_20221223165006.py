        ...
        if request.method == "POST":
            ...
            if user is not None:
                ...
                if user.is_authenticated and user.role == 'STUDENT':
                    return redirect("accounts:profile-student")
...
def student_profile(request):
    ...
    if request.method == "POST":
        user_form = UserLoginForm(StudentProfile, user=request.user)
        student_profile_form = StudentProfile(
            request.POST, request.FILES, instance=user_profile
        )
        ...
        user_form = UserLoginForm(instance=request.user)
        student_profile_form = UserLoginForm(instance=user_profile)
