...
class Subject(models.Model):
    standard = models.ForeignKey(Standard, on_delete=models.CASCADE, verbose_name='Matière')
    subject_id = models.CharField(max_length=10)
    name = models.CharField(max_length=200, verbose_name='Titre de la leçon')
    slug = models.SlugField(max_length=200)
    description = models.TextField()
    image = models.ImageField(upload_to='cours', blank='')
