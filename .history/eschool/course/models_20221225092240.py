...
class Course(models.Model):
    ...
    instructor = models.OneToOneField(Teacher, verbose_name="Enseignant", on_delete=models.CASCADE, related_name='course')
...
class InstructorSerializer(serializers.ModelSerialzer):
    course = CourseSerializer(read_only=True, many=t)
