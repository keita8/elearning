...
class Course(models.Model):
    ...
    instructor = models.OneToOneField(Teacher, verbose_name="Enseignant", on_delete=models.CASCADE)
    name = models.CharField(max_length=150, verbose_name="Matière", unique=True)
    year = models.IntegerField(verbose_name="Année", default=year_choice)
