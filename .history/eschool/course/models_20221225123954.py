...
class Lesson(models.Model):
    ...
    video =  (upload_to=upload_image_path_video, verbose_name='contenu vidéo', blank=True, null=True,  validators=[FileExtensionValidator( ['mp4'] ) ])
    pdf = (upload_to=upload_image_path_pdf, null=True, blank=True, validators=[FileExtensionValidator( ['pdf'] ) ])
    note = (upload_to=upload_image_path_pdf, null=True, blank=True, validators=[FileExtensionValidator( ['pdf', 'ppt', 'docs', 'xls'] ) ])
