...
class Lesson(models.Model):
    ...
    video =  models.FieldFile(upload_to=upload_image_path_video, verbose_name='contenu vidéo', blank=True, null=True)
    pdf = models.FileField(upload_to=upl null=True, blank=True, validators=[FileExtensionValidator( ['pdf'] ) ])
    pdf   = models.FileField(upload_to=upload_image_path_pdf, verbose_name='contenu en pdf', blank=True, null=True)
