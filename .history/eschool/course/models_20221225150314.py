...
class Subject(models.Model):
    standard = models.ForeignKey(Standard, on_delete=models.CASCADE, verbose_name='Classe', related_name='subjects')
...
class Lesson(models.Model):
    ...
    subject = models.ForeignKey(Subject, verbose_name='Cours', on_delete=models.CASCADE, related_name='lessons')
