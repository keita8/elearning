...
class Standard(models.Model):
    ...
    for r in range(2000, (datetime.now().year + 1)):
        year_choice.append((r, r))
    year = models.DateTimeField(choices=year_choice, verbose_name='Année académique', default=datetime.now)
...
class Subject(models.Model):
    ...
    description = HTMLField()
    image = models.ImageField(upload_to=upload_image_path_course, blank=True)
